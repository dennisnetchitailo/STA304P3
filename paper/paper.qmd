...
date-format: long
abstract: "This study models the German bombing campaign of Britain during the Second World War by analyzing the data collected by the Home Security War Room from 1939 to 1945 to summarise air raid damage. I use a multiple linear regression model to estimate the impact of the time an attack occurred on casualties."
format: pdf
...
I used the statistical programming language R [@citeR].... Our data [@shelter].... Following @tellingstories, we consider...
